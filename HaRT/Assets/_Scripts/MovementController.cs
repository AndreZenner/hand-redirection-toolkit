    ...
    public void MoveHand()
    {
        switch (currentMovement)
        {
            ...
            case Movement.VR:
                ...
                break;
            case Movement.Leap:
                /*if(trackedHand.GetComponent<RiggedHand>().GetLeapHand().GetPalmPose() == null) break;
                obj.transform.position = trackedHand.GetComponent<RiggedHand>().GetLeapHand().GetPalmPose().position;
                Debug.Log("pos tracked hand" + trackedHand.GetComponent<RiggedHand>().GetLeapHand().GetPalmPose().position);*/
                break;
        }
    }
